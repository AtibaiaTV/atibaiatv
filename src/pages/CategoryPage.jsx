          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {EDITORIAS.filter(e => e.label !== category).map(ed => (
                <a key={ed.slug} href={`/${ed.slug}`} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 12px', borderRadius: 8, border: '1px solid var(--border)', background: '#fff', transition: 'all .2s' }}
                ...
                >
                  ...
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke={ed.color} strokeWidth="2.5" style={{ marginLeft: 'auto' }}><path d="M9 18l6-6-6-6" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </a>
              ))}
            </div>
          </div>
